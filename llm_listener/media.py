...
class MediaSearcher:
    ...
    VISUAL_PATTERNS = [
        ...
        r"\banatomy\b",
        r"\bstructure of\b",
        # Medical visual terms - conditions with visible manifestations
        r"\blesion\b",
        r"\blesions\b",
        r"\bsore\b",
        r"\bsores\b",
        ...
        r"\bswelling\b",
        r"\binflammation\b",
        r"\binfection\b.*\bskin\b",
        r"\bskin\b.*\binfection\b",
        # Disease names that commonly have visual presentations
        r"\bmpox\b",
        r"\bmonkeypox\b",
        r"\bchickenpox\b",
        r"\bshingles\b",
